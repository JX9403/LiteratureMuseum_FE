...
import { deleteStory, getAllStories } from "../../../api/StoryAPI";
import Storiesearch from "./StorySearch";
...
export default function StoryTable() {
  ...
  const confirmDelete = async (id) => {
    try {
      ...
      setStory(story.filter((n) => n.id !== id));
      setToastBg("success");
  ...
  return (
    <>
      <div className="manage-story-table">
        <Storiesearch onSearch={handleSearch} />
        <div
          ...
          <table className="table table-striped">
            <thead>
              <tr>
                ...
                <th style={{ width: "40%" }}>Tên câu chuyện</th>
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>Bạn có chắc chắn muốn xóa bài báo ID {storyToDelete}?</p>
                </div>
                <div className="modal-footer">
                  ...
                  <button
                    type="button"
                    className="btn btn-danger"
                    onClick={() => confirmDelete(storyToDelete)}
                  >
                    Xóa
                  </button>
                </div>
