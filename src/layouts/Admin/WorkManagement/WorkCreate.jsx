...
import { getAllWorks } from "../../../api/WorkAPI"; // gọi tác giả
...
const WorkCreate = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setToastBg("success");
      setToastMessage("Tạo tác phẩm thành công!");
      setShowToast(true);
      ...
      console.error("❌ Lỗi khi tạo tác phẩm:", err);
      setToastBg("danger");
  ...
  return (
    <div className="container py-4 new-create">
      <div className="top-name d-flex justify-content-between align-items-center">
        <h4 className="mb-4 color-red-text font-w-500">Thêm tác phẩm</h4>
